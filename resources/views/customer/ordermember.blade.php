                        ...
                        <form action="" method="post" role="form">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="ho_kh" class="form-control select2" value="{{ $thanh_vien->ho_thanh_vien }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="ten_kh" class="form-control select2" value="{{ $thanh_vien->ten_thanh_vien }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control select2" value="{{ $thanh_vien->email  }}">
                                <small id="ten_khHelp" class="form-text text-danger">
                                    @if ($errors->has('email'))
                                        {{ $errors->first('email') }}
                                    @endif
                                        ...
                                        @if (Session::has('ma_code'))
                                            <tr>
                                                <td class="text-black font-weight-bold">
                                                    ...
                                                    <a class="icons icon-remove" href="/khach-hang/xoa-ma-giam-gia"> dùng mã khác</a>
                                                </td>
                                                <td class="text-black font-weight-bold">
